...
module.exports = {
    ...
    run: async function(client, message, args) {
        try {
            ...
            var nameer = `form-${message.author.username}`
            ...
            if (check == null || !check) {
                message.channel.send({
                    embed: {
                        color: 0xFF0000,
                        title: `**❌ | Error**`,
                        description: `You have to setup the Form system with this command: \`${prefix}setup\``
                    }
                }).then(async function(m) {
                    setTimeout(() => {
                        m.delete()
            ...
            message.channel.send({
                embed: {
                    ...
                    description: `Are you sure about create a new Form?`,
                    color: 0xFFF200
                },
                component: row
